...
func Populate(context *docker.Context, c *cli.Context) {
	...
	opts.TLS = c.Bool("tls")
	opts.TLSVerify = c.Bool("tlsverify")
	opts.TLSOptions.CAFile = c.String("tlscacert")
	opts.TLSOptions.CertFile = c.String("tlscert")
	opts.TLSOptions.KeyFile = c.String("tlskey")
